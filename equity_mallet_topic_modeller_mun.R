...
documents <- mallet.read.dir("C:\\a_orgs\\carleton\\hist3814\\equity_subcollections\\Mun El")
...
write.csv(topic.docs, "C:\\a_orgs\\carleton\\hist3814\\R\\hist3814o-final\\equity-topics-docs-mun-el.csv")
...
topics.labels
write.csv(topics.labels, "C:\\a_orgs\\carleton\\hist3814\\R\\hist3814o-final\\equity-topics-labels-mun-el.csv")
