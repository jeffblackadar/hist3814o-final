...
dir <- "C:\\a_orgs\\carleton\\hist3814\\R\\working\\" # adjust to suit
setwd(dir)
require(mallet)
...
documents <- mallet.read.dir("C:\\a_orgs\\carleton\\hist3814\\equity_subcollections\\1970-1980")
...
write.csv(topic.docs, "C:\\a_orgs\\carleton\\hist3814\\R\\hist3814o-final\\equity-topics-docs-1970-1980.csv")
...
topics.labels
write.csv(topics.labels, "C:\\a_orgs\\carleton\\hist3814\\R\\hist3814o-final\\equity-topics-labels-1970-1980.csv")
